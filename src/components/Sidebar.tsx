...
const navItems = [
  { path: '/', emoji: '📈', label: '任务总览' },
  { path: '/history', emoji: '📜', label: '任务记录' },
  { path: '/settings', emoji: '🧰', label: '应用设置' },
  { path: '/about', emoji: '🪐', label: '关于应用' }
]
      ...
      <div className="px-4 pb-4 pt-5">
        ...
        <div className="flex items-center justify-between px-1">
          ...
          <button
            ...
            title={mode === 'dark' ? '切换为亮色模式' : '切换为深色模式'}
            aria-label={mode === 'dark' ? '切换为亮色模式' : '切换为深色模式'}
          ...
          <div className="mt-2.5 space-y-1.5">
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] font-semibold text-slate-600 dark:text-neutral-300">下载</span>
              </span>
            ...
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] font-medium text-slate-500 dark:text-neutral-400">上传</span>
              </span>
